...
import org.ot5usk.steps.assertions.lib_api_asserts.GetAllBooksByAuthorXmlAsserts;
...
public class GetAllBooksByAuthorXmlTest {
    ...
    private AddNewBookResponse expectedBookResponse;
    ...
    @Tag("get")
    @Tag("positive")
    @DisplayName("Correct author without books .xml")
    @Description("status-code: 200")
    @Test
    void byCorrectAuthorWithoutBooks() {
        ...
        List<GetAllBooksByAuthorResponse> currentBooksResponse = requestSpecGetAllBooksByAuthorXml(currentAuthor.getAuthorId().toString(), 200).getBooks();
